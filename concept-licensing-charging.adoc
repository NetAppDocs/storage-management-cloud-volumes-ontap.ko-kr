...
NOTE: NetApp은 BYOL 라이선스의 구매, 연장 및 갱신을 제한하고 있으며, 프라이빗 모드 배포 등 특정 시나리오에서 사용 가능 여부를 제한하고 있습니다. 자세한 내용은 https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/whats-new.html#restricted-availability-of-byol-licensing-for-cloud-volumes-ontap["Cloud Volumes ONTAP 에 대한 BYOL 라이선싱의 제한된 가용성"^]을 참조하십시오.
