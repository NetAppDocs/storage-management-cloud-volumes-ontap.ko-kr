...
* BYOL 라이센스와 마켓플레이스의 연간 계약이 있는 경우 소비 및 초과분은 설정한 청구 기본 설정에 따라 청구됩니다. 청구 방법을 이해하려면 link:concept-licensing-charging.html#concept-licensing-charging.html#billing-preferences-and-overages["요금 설정 및 초과 사용 요금"]을(를) 참조하십시오.
