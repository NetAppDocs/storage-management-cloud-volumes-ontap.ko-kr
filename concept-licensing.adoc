...
BYOL 라이선스는 NetApp에서 구매할 수 있으며 모든 클라우드 공급자에서 사용할 수 있습니다. BYOL 라이선스 사용 가능 여부에 대한 자세한 내용은 https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/whats-new.html#restricted-availability-of-byol-licensing-for-cloud-volumes-ontap["Cloud Volumes ONTAP 에 대한 BYOL 라이선싱의 제한된 가용성"^]을 참조하십시오.
...
* link:link:reference-configs-azure.html["Azure에서 지원되는 구성"]
...
* link:link:reference-configs-gcp.html["Google Cloud에서 지원되는 구성"^]
