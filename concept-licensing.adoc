...
클라우드 마켓플레이스 또는 NetApp(BYOL(Bring Your Own License))을 통해 라이선스 및 구독을 구매하거나 갱신할 수 있습니다. 마켓플레이스에서는 연간 구독 및 종량제(PAYGO) 옵션을 제공합니다. 자세한 내용은 link:concept-license-management.html["Cloud Volumes ONTAP 의 용량 기반 라이선스에 대해 자세히 알아보세요."]을 참조하십시오.
