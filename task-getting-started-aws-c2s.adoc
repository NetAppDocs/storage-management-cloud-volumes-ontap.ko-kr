...
summary: Cloud Volumes ONTAP을 AWS Secret Cloud 및 Top Secret Cloud 환경에 배포할 수 있습니다. AWS Secret Cloud 및 Top Secret Cloud 리전은 미국 정보기관 전용으로 운영되는 폐쇄형 리전입니다. 이 페이지의 지침은 AWS Secret Cloud 및 Top Secret Cloud 리전 사용자에게만 적용됩니다. 
---
...
+
개인 모드 작동 방식에 대한 자세한 내용은 link:https://docs.netapp.com/us-en/console-setup-admin/concept-modes.html#private-mode["콘솔의 개인 배포 모드"^]을(를) 참조하십시오.
...
. Amazon Simple Storage Service(Amazon S3) 서비스에 대한 VPC 엔드포인트를 설정합니다.
+
