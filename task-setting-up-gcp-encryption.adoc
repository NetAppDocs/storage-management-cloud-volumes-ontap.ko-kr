...
+
권한은 다음에서 제공됩니다. https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-gcp.html["기본적으로 서비스 계정 권한"^] 하지만 Cloud Key Management Service에 대한 대체 프로젝트를 사용하는 경우에는 적용되지 않을 수 있습니다.
...
. 시스템을 생성할 때 API 요청에 "gcpEncryption" 매개변수를 사용하십시오.
+
*예*
...
----
 ...
 https://docs.netapp.com/us-en/console-automation/index.html["NetApp Console 자동화 문서"^]의 "GcpEncryption" 매개변수 사용에 대한 자세한 내용은 해당 문서를 참조하십시오.
