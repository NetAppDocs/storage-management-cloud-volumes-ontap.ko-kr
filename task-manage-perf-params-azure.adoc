...
API를 사용하여 Premium SSD v2 디스크 설정을 수정하는 프로세스를 자동화합니다. Cloud Volumes ONTAP API 호출 실행에 대한 자세한 내용은 https://docs.netapp.com/us-en/console-automation/cm/your_api_call.html#step-1-select-the-identifie["첫 번째 API 호출"^]을 참조하십시오.
...
.관련 정보
* https://docs.netapp.com/us-en/console-automation/cm/prepare.html["API 사용을 준비하세요"^]
* https://docs.netapp.com/us-en/console-automation/cm/workflow_processes.html#organization-of-cloud-volumes-ontap-workflows["Cloud Volumes ONTAP 워크플로"^]
* https://docs.netapp.com/us-en/console-automation/platform/get_identifiers.html#get-the-connector-identifier["필수 식별자 가져오기"^]
* https://docs.netapp.com/us-en/console-automation/platform/use_rest_apis.html["Cloud Volumes ONTAP 용 REST API 사용"^]
