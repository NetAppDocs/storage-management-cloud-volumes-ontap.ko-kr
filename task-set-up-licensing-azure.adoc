...
프로비저닝된 용량이 최대 500GiB인 Cloud Volumes ONTAP을 무료로 사용하려면 Freemium 오퍼링을 선택하십시오. link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html#packages["Freemium 제공에 대해 자세히 알아보세요"^].
...
+
마켓플레이스 구독을 통한 요금은 프로비저닝된 용량이 500GiB를 초과하지 않는 한 부과되지 않으며, 초과하는 경우 시스템은 자동으로 link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing.html#capacity-based-licensing["필수 패키지"^]으로 전환됩니다.
...
NOTE: NetApp은 BYOL 라이선스의 구매, 연장 및 갱신을 제한합니다. 자세한 내용은 https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/whats-new.html#restricted-availability-of-byol-licensing-for-cloud-volumes-ontap["Cloud Volumes ONTAP 에 대한 BYOL 라이선싱의 제한된 가용성"^]을 참조하십시오.
...
+
Cloud Volumes ONTAP에서 사용하려면 먼저 콘솔에서 라이센스를 사용할 수 있어야 합니다. 필요한 경우 link:task-manage-capacity-licenses.html#how-licenses-are-added-to-netapp-console["콘솔에 라이센스를 수동으로 추가합니다."]할 수 있습니다.
...
TIP: 설정 > 자격 증명 페이지에서 Azure 계정과 연결된 Azure Marketplace 구독을 관리할 수 있습니다. https://docs.netapp.com/us-en/console-setup-admin/task-adding-azure-accounts.html["Azure 계정 및 구독을 관리하는 방법을 알아보세요."^]
