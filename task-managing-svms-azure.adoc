...
Cloud Volumes ONTAP API 호출 실행에 대한 자세한 내용은  https://docs.netapp.com/us-en/console-automation/cm/your_api_call.html#step-1-select-the-identifie["첫 번째 API 호출"^]을 참조하십시오.
...
구성 및 라이센스 유형에 따라 NetApp Console용 API를 사용하여 단일 노드 시스템 또는 고가용성(HA) 구성에서 여러 스토리지 VM을 생성할 수 있습니다.
...
.시작하기 전에
콘솔 에이전트는 Cloud Volumes ONTAP에 대한 스토리지 VM을 생성하기 위해 특정 권한이 필요합니다. 필요한 권한은 https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-azure.html["NetApp 에서 제공하는 정책"^]에 포함되어 있습니다.
...
.시작하기 전에
콘솔 에이전트는 Cloud Volumes ONTAP의 스토리지 VM을 관리하기 위한 특정 권한이 필요합니다. 필요한 권한은 https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-azure.html["NetApp 에서 제공하는 정책"^]에 포함되어 있습니다.
