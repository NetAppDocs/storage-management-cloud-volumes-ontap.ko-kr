...
. NetApp Console 메뉴에서 *관리 > Licenses and subscriptions*을 선택합니다.
. * Keystone 구독*을 선택하세요.
. 연결하려는 구독에 대해 image:icon-action.png["세 개의 점이 나란히 있는 아이콘"]를 선택하고 *연결*을 선택합니다.
...
. NetApp Console 메뉴에서 *관리 > Licenses and subscriptions*을 선택합니다.
. * Keystone 구독*을 선택하세요.
. 용량을 조정하려는 구독의 경우 image:icon-action.png["세 개의 점이 나란히 있는 아이콘"]를 선택하고 *상세 보기 및 편집*을 선택합니다.
. 하나 이상의 구독에 대해 요청된 약정 용량을 입력하세요.
. 아래로 스크롤하여 요청에 대한 추가 정보를 입력한 다음 *Submit*을 선택합니다.
...
. NetApp Console 메뉴에서 *관리 > Licenses and subscriptions*을 선택합니다.
. * Keystone*을 선택하세요.
. 연결을 해제하려는 구독의 경우 image:icon-action.png["세 개의 점이 나란히 있는 아이콘"]를 선택하고 *연결 해제*를 선택합니다.
