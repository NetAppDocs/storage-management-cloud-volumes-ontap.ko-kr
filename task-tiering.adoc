...
----
사용자 지정 역할에는 기본적으로 권한이 포함됩니다. https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-azure.html["콘솔 에이전트에 대한 Azure 권한 보기"^]
...
+
데이터 복제에 대한 도움말은  https://docs.netapp.com/us-en/data-services-replication/task-replicating-data.html["클라우드에서 데이터 복제 및 클라우드로 데이터 복제"^]을 참조하십시오.
...
. Cloud Volumes ONTAP 시스템을 관리하는 콘솔 에이전트의 image:icon-action.png["추가 작업을 위한 가로 점 세 개가 표시된 아이콘입니다."] 아이콘을 클릭하십시오.
