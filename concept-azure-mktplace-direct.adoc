...
| 다양한 VM 유형을 제공합니다.link:reference-configs-azure.html["Azure에서 지원되는 구성"] 
...
| *지원되는 디스크 유형* | 프리미엄 SSD v2 관리 디스크 | 더 폭넓은 지원. link:reference-configs-azure.html#azure-storage-for-user-data["Azure에서 지원되는 디스크 유형"] 
...
* link:https://docs.netapp.com/us-en/console-family/index.html["NetApp Console 설명서"^]
