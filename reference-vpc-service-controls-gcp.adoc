...
정책을 사용하면 VPC Service Controls 규칙 집합에 대한 예외를 허용할 수 있습니다. 정책에 대한 자세한 내용은 해당 페이지를 참조하십시오 https://cloud.google.com/vpc-service-controls/docs/ingress-egress-rules#policy-model["Google Cloud VPC Service Controls 정책 설명서"^].
