...
** 개인 모드 배포를 위해 네트워크 구성을 완료하고 작업자 풀을 생성했는지 확인하십시오. 자세한 내용은 link:reference-networking-gcp.html#infrastructure-manager-configuration-in-private-mode-or-protected-environments["프라이빗 모드 배포를 위한 Infrastructure Manager 구성"]을 참조하십시오.
...
[%collapsible]
====
 `--worker-pool` 매개변수를 지정하여 개인 모드 배포에서 도구를 실행하십시오. 작업자 풀 구성에 대해서는 link:reference-networking-gcp.html#infrastructure-manager-configuration-in-private-mode-or-protected-environments["프라이빗 모드 배포를 위한 Infrastructure Manager 구성"]을 참조하십시오.
