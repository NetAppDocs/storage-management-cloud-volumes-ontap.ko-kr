...
+
link:https://www.netapp.com/pdf.html?item=/media/9088-tr4383.pdf["NetApp 기술 보고서 ​​4383: 애플리케이션 워크로드를 포함한 Amazon Web Services의 Cloud Volumes ONTAP 성능 특성 분석"^]
...
+
link:https://www.netapp.com/pdf.html?item=/media/9089-tr-4671.pdf["NetApp 기술 보고서 ​​4671: 애플리케이션 워크로드를 포함한 Azure의 Cloud Volumes ONTAP 성능 특성 분석"^]
