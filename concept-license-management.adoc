...
---
= Cloud Volumes ONTAP 노드 기반 BYOL에 대해 알아보기
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
link:concept-licensing.html["Cloud Volumes ONTAP 라이선스에 대해 알아보세요"].

link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-manage-node-licenses.html["노드 기반 라이선스를 관리하는 방법에 대해 자세히 알아보세요."^].
...
https://docs.netapp.com/us-en/console-setup-admin/task-adding-nss-accounts.html["콘솔에 NetApp 지원 사이트 계정을 추가하는 방법을 알아보세요."^].
