...
. 필요한 콘솔 에이전트의 image:icon-action.png["추가 작업을 위한 가로 점 세 개가 표시된 아이콘입니다."] 아이콘을 클릭하고 *콘솔 에이전트 편집*을 선택합니다.
...
* https://docs.netapp.com/us-en/ontap/concept_administration_overview.html["ONTAP System Manager를 사용한 클러스터 관리에 대해 알아보세요"^]
