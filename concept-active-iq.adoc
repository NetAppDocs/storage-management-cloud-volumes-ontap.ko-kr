...
* 콘솔에 NSS 계정을 등록하지 않은 경우 지금 NSS 계정을 등록하면 Digital Advisor UI가 나타납니다. 지침은 https://docs.netapp.com/us-en/console-setup-admin/task-adding-nss-accounts.html["조직 또는 계정과 연결된 NSS 자격 증명 관리"]을 참조하십시오.
