...
AWS에서 Cloud Volumes ONTAP 시스템을 시작하면 다음을 사용하여 데이터 암호화를 활성화할 수 있습니다. http://docs.aws.amazon.com/kms/latest/developerguide/overview.html["AWS 키 관리 서비스(KMS)"^] .  NetApp 콘솔은 고객 마스터 키(CMK)를 사용하여 데이터 키를 요청합니다.
