...
* 해당 구독은 Microsoft `Microsoft.Compute/VMOrchestratorZonalMultiFD` 기능에 등록되었습니다. https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/task-saz-feature.html["단일 가용성 영역에 대해 VMOrchestratorZonalMultiFD를 활성화하는 방법을 알아봅니다."^].
...
* https://docs.netapp.com/us-en/bluexp-cloud-volumes-ontap/concept-ha-azure.html["Azure의 고가용성 쌍에 대해 알아보기"^].
