...
---
= AWS의 고급 옵션을 사용하여 Cloud Volumes ONTAP 배포
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
* 이미 실행 중인 콘솔 에이전트입니다.
+
** 다음이 있어야 합니다 https://docs.netapp.com/us-en/console-setup-admin/task-quick-start-connector-aws.html["시스템과 연결된 콘솔 에이전트"^].
...
. 메시지가 표시되면, https://docs.netapp.com/us-en/console-setup-admin/task-quick-start-connector-aws.html["콘솔 에이전트 생성"^].
...
| 자격 증명 편집 | 이 시스템을 배포할 계정과 연결된 AWS 자격 증명을 선택하십시오. AWS 마켓플레이스 구독을 이 Cloud Volumes ONTAP 시스템과 연결할 수도 있습니다. 선택한 자격 증명을 새 AWS 마켓플레이스 구독과 연결하려면 *구독 추가*를 클릭하십시오. 구독은 연간 계약 또는 Cloud Volumes ONTAP 시간당 요금으로 결제하는 방식일 수 있습니다. https://docs.netapp.com/us-en/console-setup-admin/task-adding-aws-accounts.html["NetApp Console 에 추가 AWS 자격 증명을 추가하는 방법을 알아보세요."^]. 
|===
+
...
. *위치 및 연결*:  https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-planning-your-config.html#collect-networking-information["AWS 워크시트"^]에서 기록한 네트워크 정보를 입력하십시오.
+
...
| 자격 증명 편집 | 이 Cloud Volumes ONTAP 시스템에서 사용할 AWS 자격 증명과 마켓플레이스 구독을 선택하십시오. 선택한 자격 증명을 새 AWS 마켓플레이스 구독과 연결하려면 *구독 추가*를 클릭하십시오. 구독은 연간 계약 또는 Cloud Volumes ONTAP 시간당 요금으로 이용하는 방식으로 선택할 수 있습니다. NetApp에서 직접 라이선스를 구매한 경우(BYOL, Bring-Your-Own License) AWS 구독은 필요하지 않습니다. NetApp은 BYOL 라이선스의 구매, 연장 및 갱신을 제한하고 있습니다. 자세한 내용은 https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/whats-new.html#restricted-availability-of-byol-licensing-for-cloud-volumes-ontap["Cloud Volumes ONTAP 에 대한 BYOL 라이선싱의 제한된 가용성"^]을 참조하십시오. https://docs.netapp.com/us-en/console-setup-admin/task-adding-aws-accounts.html["콘솔에 추가 AWS 자격 증명을 추가하는 방법을 알아보세요."^]. 
|===
+
...
+
** https://docs.netapp.com/us-en/data-services-data-classification/concept-cloud-compliance.html["NetApp Data Classification 에 대해 자세히 알아보세요"^]
** https://docs.netapp.com/us-en/data-services-backup-recovery/task-backup-to-s3.html["백업 및 복구에 대해 자세히 알아보세요"^]
+
...
+
IP 주소는 해당 리전의 모든 VPC에 대해 CIDR 블록 외부에 있어야 합니다. 자세한 내용은 link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/reference-networking-aws.html#requirements-for-ha-pairs-in-multiple-azs["여러 AZ에서 Cloud Volumes ONTAP HA에 대한 AWS 네트워킹 요구 사항"^]을 참조하십시오.
...
. *사용 프로필, 디스크 유형 및 계층화 정책*: 스토리지 효율성 기능을 활성화할지 여부를 선택하고 필요한 경우 볼륨 계층화 정책을 편집합니다.
+
자세한 내용은 link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-planning-your-config.html#choose-a-volume-usage-profile["볼륨 사용 프로필을 선택하세요"^] 및 link:concept-data-tiering.html["데이터 계층화 개요"^]을 참조하십시오.
...
.관련 링크
* link:task-onboard-cvo-aws-marketplace.html["AWS Marketplace에서 Cloud Volumes ONTAP 구독 및 배포"]
