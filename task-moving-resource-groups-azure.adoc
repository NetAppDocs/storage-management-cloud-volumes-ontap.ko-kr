...
.단계
. Cloud Volumes ONTAP 시스템을 제거하십시오. 자세한 내용은 link:https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/task-removing.html["Cloud Volumes ONTAP 시스템 제거"]을 참조하십시오.
