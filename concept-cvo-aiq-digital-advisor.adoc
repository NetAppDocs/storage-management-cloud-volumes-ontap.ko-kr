...
[role="lead"]
https://www.netapp.com/data-services/digital-advisor/["NetApp Active IQ Digital Advisor"^](Digital Advisor라고도 함)는 NetApp Console에 통합되어 있어 단일 화면에서 Cloud Volumes ONTAP 시스템의 운영, 보안 및 성능을 최적화할 수 있습니다.
