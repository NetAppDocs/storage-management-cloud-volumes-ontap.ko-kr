...
summary: 직접 집계를 만들 수도 있고 NetApp 콘솔에서 볼륨을 생성할 때 집계를 대신 만들어 줄 수도 있습니다.  집계를 직접 만드는 이점은 기본 디스크 크기를 선택할 수 있다는 점입니다. 즉, 필요한 용량이나 성능에 맞게 집계 크기를 조정할 수 있습니다. 
---
...
[role="lead"]
직접 집계를 만들 수도 있고 NetApp 콘솔에서 볼륨을 생성할 때 집계를 대신 만들어 줄 수도 있습니다.  집계를 직접 만드는 이점은 기본 디스크 크기를 선택할 수 있다는 점입니다. 즉, 필요한 용량이나 성능에 맞게 집계 크기를 조정할 수 있습니다.
