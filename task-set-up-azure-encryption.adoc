...
----
https://docs.netapp.com/us-en/console-setup-admin/reference-permissions-azure.html["최신 권한 목록 보기"^]

.단계
. 다음 API 호출을 사용하여 Azure 구독에 있는 키 자격 증명 모음 목록을 가져옵니다.
+
https://docs.netapp.com/us-en/console-automation/cvo/get-azure-ha-metadata-keys-vault.html["HA 쌍의 경우"^]: `GET /azure/ha/metadata/vaults`

+
https://docs.netapp.com/us-en/console-automation/cvo/get-azure-vsa-metadata-keys-vault.html["단일 노드의 경우"^]: `GET /azure/vsa/metadata/vaults`
...
+
HA 쌍의 경우: `GET /azure/ha/metadata/keys-vault?resourceGroupName=KeyVaultResourceGroup&vaultName=KeyVault`

+
단일 노드의 경우: `GET /azure/vsa/metadata/keys-vault?resourceGroupName=KeyVaultResourceGroup&vaultName=KeyVault`
...
+
.. HA 쌍의 경우 다음을 사용하십시오 https://docs.netapp.com/us-en/console-automation/cvo/post-azure-ha-working-environments.html["이 API 호출"^]:
+
...
.. 단일 노드 시스템의 경우 다음을 사용하십시오 https://docs.netapp.com/us-en/console-automation/cvo/post-azure-vsa-working-environments.html["이 API 호출"^]:
+
...
.관련 링크
* https://docs.netapp.com/us-en/console-automation/cm/wf_cvo_before.html["Cloud Volumes ONTAP API 워크플로우 사용을 준비하세요"^].
* https://docs.netapp.com/us-en/console-automation/cm/api_ref_resources.html#azure-haworking-environments["ONTAP 관리 REST API에 대해 알아보십시오"^].
