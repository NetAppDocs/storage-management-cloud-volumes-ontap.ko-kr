...
| 총 사전 약속 용량 | BYOL 라이선스 및 Marketplace 계약을 포함하여 NetApp에서 구매한 총 라이선스 용량입니다. 이 값은 총 BYOL 용량과 총 Marketplace 계약 용량의 합계입니다. 


| 총 BYOL 용량 | NetApp에서 직접 구매한 BYOL(Bring Your Own License) 라이센스가 적용되는 사전 약정 용량의 부분입니다. 


| 총 마켓플레이스 계약 용량 | 클라우드 제공업체의 마켓플레이스를 통해 구매한 연간 마켓플레이스 계약 또는 비공개 오퍼로 확보된 사전 약정 용량의 비율입니다. 
...
| 총 사전 약속 용량 | NetApp에서 구매한 이 패키지의 총 라이선스 용량(BYOL 라이선스 및 마켓플레이스 계약 포함)입니다. 이 값은 총 BYOL 용량과 총 마켓플레이스 계약 용량의 합계입니다. 


| 총 BYOL 용량 | 이 패키지에 대해 사전 약정된 용량 중 사용자가 NetApp에서 직접 구매한 BYOL(Bring Your Own License) 라이센스로 적용되는 부분입니다. 


| 총 마켓플레이스 계약 용량 | 이 패키지에 대해 사전 약정된 용량의 일부는 클라우드 공급업체의 마켓플레이스를 통해 구매한 연간 마켓플레이스 계약 또는 비공개 오퍼로 충당됩니다. 
...
| 충전 용량 반올림 | SVM에 실제로 청구된 용량입니다. 각 SVM에는 최소 청구 가능 용량(기본값 4TiB, 계정별로 다를 수 있음)이 있습니다. SVM에 프로비저닝된 용량이 최소값 이하인 경우 이 값은 최소값으로 올림 처리되고, 그렇지 않으면 프로비저닝된 용량과 동일하게 처리됩니다. 


| 마켓플레이스 청구 기간 | 관련 마켓플레이스 구독의 청구 기간(예: 시간 단위 또는 연간). 


| Cloud Volumes ONTAP 패키지 또는 기능 | SVM과 관련된 라이선스 패키지 또는 기능(예: Essentials 또는 Professional). 


| SaaS Marketplace 구독 이름 청구 | 결제에 사용되는 마켓플레이스 구독 이름입니다. 


| SaaS 마켓플레이스 구독 ID 청구 | 결제에 사용되는 마켓플레이스 구독의 고유 식별자입니다. 


| 작업 유형 | SVM의 볼륨이 운영 데이터에 사용되는 *기본*(읽기/쓰기) 볼륨인지, 아니면 백업 및 복제에 사용되는 SnapMirror 복제본과 같은 데이터 보호 대상 볼륨인 *보조*(DP) 볼륨인지를 나타냅니다. 
|===
...
* https://docs.netapp.com/us-en/storage-management-cloud-volumes-ontap/concept-licensing-charging.html["용량 기반 라이선스에 대해 자세히 알아보세요"^]
