...
+
이 옵션은 특정 VM 유형에서만 사용할 수 있습니다. 지원되는 VM 유형을 확인하려면 link:link:reference-configs-azure.html#ha-pairs["HA 쌍에 대한 라이선스별 지원 구성"]을 참조하십시오.
...
+
link:link:reference-configs-azure.html#ha-pairs["Azure에서 지원되는 구성에 대해 자세히 알아보세요."^].
