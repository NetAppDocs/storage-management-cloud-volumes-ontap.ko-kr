...
+
https://docs.netapp.com/us-en/data-services-data-classification/concept-cloud-compliance.html#the-cloud-data-sense-instance["데이터 분류 인스턴스에 대해 자세히 알아보세요"^].

. Cloud Volumes ONTAP 시스템을 삭제합니다.
+
.. *시스템* 페이지에서 삭제하려는 Cloud Volumes ONTAP 시스템의 이름을 두 번 클릭합니다.
.. 콘솔 오른쪽 상단의 image:icon-action.png["추가 작업을 위한 가로 점 세 개가 표시된 아이콘입니다."] 아이콘을 클릭하고 *삭제*를 선택합니다.
